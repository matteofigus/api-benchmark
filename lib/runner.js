...
module.exports = function(options){
  ...
  this.add = function(stepName, href, func){
    ...
    step.run = function(callback){
      ...
      var isSequence = self.options.runMode == 'sequence',
      ...
      var sampleDone = function(sample, pos){
        ...
        var currentGlobalTime = self.getCurrentTime(globalTimer),
  ...
  this.getCurrentTime = function(timer){
    var currentGlobalTime = timer.get();

    if(this.options.runMode == 'sequence'){
      timer.stop();
      currentGlobalTime = timer.time;
    }
