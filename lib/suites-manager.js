  ...
  return _.extend(this, {
    addEndpoints: function(endpoints){
      ...
      for(endpointName in endpoints){
        this.routes.push({
          ...
          runner: new BenchmarkRunnerHandler(Suite, this.options)
        });
      }
      return this;
    },
    ...
    logComparisonResult: function(route, callback){
      route.runner.onComplete(function(e){
        if(_.has(e, '1')){
          var fasterName = _.find(e, function(result){ return result.isFastest == true; }).name;
          debugHelper.log('Fastest is ' + fasterName);
        }
