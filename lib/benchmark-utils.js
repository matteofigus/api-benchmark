...
var benchmarkUtils = {
  ...
  getRelevantFields: function(benchmark){
    ...
    stats.p75 = __.getPercentile(benchmark.stats.sample, .75);
    stats.p95 = __.getPercentile(benchmark.stats.sample, .95);
    stats.p99 = __.getPercentile(benchmark.stats.sample, .99);
    stats.p999 = __.getPercentile(benchmark.stats.sample, .999);
